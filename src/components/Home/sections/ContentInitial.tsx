...
export default function ContentInitial() {
    ...
    return (
        <section className="relative w-full min-h-screen bg-background flex items-center justify-center overflow-hidden">
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-125 h-125 bg-blue/5 rounded-full blur-[120px] pointer-events-none"></div>

            <section className="max-w-7xl w-full mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-12 items-center z-10">

                <div className="relative flex justify-center md:justify-start" data-aos="fade-right" data-aos-duration="1200">
                    <div className="relative group">
                        <div className="absolute -inset-4 border border-white/5 rounded-2xl group-hover:border-blue/30 transition-colors duration-500"></div>
                        <Image
                            height={600}
                            width={500}
                            alt="Wendell Bonucci || Software Engineer"
                            src='/dev.png'
                            className="relative z-10 object-cover rounded-xl transition-all duration-700 brightness-90 hover:brightness-110"
                            priority
                        />
                    </div>
                </div>
                ...
                >
                    ...
                    <div className="flex items-center gap-4 mb-8">
                        ...
                        <p className="text-white/60 text-lg md:text-xl font-light tracking-[0.15em] uppercase">Engenheiro de Software || FullStack</p>
                    </div>
